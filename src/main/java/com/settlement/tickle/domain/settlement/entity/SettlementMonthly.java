...
// 참고: DDL의 uniq_settlement_monthly_normal은 entry_type = 'NORMAL' 조건부(partial) 유니크 인덱스라
...
public class SettlementMonthly {
    ...
    @CreatedDate
    @Column(name = "settlement_monthly_created_at", nullable = false, updatable = false)
    private LocalDateTime createdAt;

    @Builder
    public SettlementMonthly(Member member, Performance performance, String performanceTitle,
                              Integer settlementYear, Integer settlementMonth, SettlementEntryType entryType,
